...
export async function resetDb(): Promise<void> {
  await db.execute(
    sql`TRUNCATE TABLE photo_embeddings, ai_analysis_events, photo_collections, project_photos, projects, collections, ratings, photos, albums, "user", session, account, verification, users RESTART IDENTITY CASCADE`,
  );
}
